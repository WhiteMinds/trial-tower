...
export type CharacterAttrsOnlyDefine = Omit<CharacterAttrs, keyof AutoGeneratedAttrs>
export type CharacterCreateAttrs = CharacterAttrsOnlyDefine

interface CharacterModel extends Model<CharacterAttrs, CharacterCreateAttrs>, CharacterAttrs {}
...
export function defineCharacterModel(sequelize: Sequelize) {
  ...
  const modelCtor = class Character extends sequelize.define<CharacterModel, CharacterAttrsOnlyDefine>(
    'Character',
    attrs,
  ) {}
