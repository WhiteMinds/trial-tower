...
import { module as equipModule } from './module/equip'
import { CombatSystemModule } from './module/types'

const ProgressNeedPoint = 100
const modules: CombatSystemModule[] = [equipModule]
...
function toBattlingEntity(entity: Entity): BattlingEntity {
  return {
    ...entity,
    progress: 0,
    currentHP: AttrDescriptor.getValue(entity, entity.maxHP)
  }
}
